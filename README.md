...
* **Design a simple object-oriented ch.heigvd.res.model** to implement the functional requirements described in the next paragraph.
...
- The program must be configurable: the addresses, groups, messages CANNOT be hard-coded in the program and MUST be managed in ch.heigvd.res.config files.
...
* Testing SMTP with TLS: `openssl s_client -connect ch.heigvd.res.smtp.mailtrap.io:2525 -starttls ch.heigvd.res.smtp -crlf`
